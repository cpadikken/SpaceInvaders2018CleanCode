...
public abstract class Projectile extends DestroyableGameObject implements ICollidableWithGameObjects, ICollidableWithTiles {
	 ...
	 * 
	 * @param sprite
	 *            Afbeelding van het projectiel
	 * @param totalFrames
	 *            Aantal frames waaruit de afbeeldng bestaat
	 * @param sWidth
	 ...
	 */
	public Projectile(Sprite sprite, int totalFrames, int sWidth, int sHeight, boolean isFriendly, SpaceInvaders world,
			AttackCapableGameObject source) {
